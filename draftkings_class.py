...
id_dict = {"NHL": "42133", "NFL": "88808",
           "NBA": "42648", "England - Premier League": "40253", "UCL": "40685"}


class DraftKings:
    def __init__(self, league= "UCL"):
        """
        ...
        self.uri = "wss://sportsbook-ws-us-ny.draftkings.com/websocket?format=msgpack"
    ...
    def get_event_ids(self) -> dict:
        ...
        """
        event_ids = {}
        response = urlfetch.fetch(self.pregame_url)
    ...
    def live_odds_stream(self, event_ids=None, markets=None):
        ...
        """
        asyncio.run(stream(
            uri=self.uri, url= self.pregame_url, league_id=id_dict[self.league], event_ids=event_ids, markets=markets))
